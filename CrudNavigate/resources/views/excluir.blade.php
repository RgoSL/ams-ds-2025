...
<body>
    ...
    <section>
        <ul class="nav nav-underline">
            <li class="nav-item">
              <a class="nav-link active" aria-current="page" href="/excluir-clientes/1">Excluir</a>
            </li>
            <li class="nav-item">
    ...
    <section>
        ...
        <form action="/excluir_clientes" method="POST">
            @csrf
            ...
            <div class="container_obs">
                <label class="lbObservacao">Observações</label>
